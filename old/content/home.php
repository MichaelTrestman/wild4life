...
<!-- begin box 2 -->
<div class="box_mid">
<a href="#" onclick="gonav(2); return false;"><img src="img/home/content_boxes/3.jpg" alt="Who We Are" title="" border="0"></a>
<h2><a href="#" onclick="gonav(2); return false;">Health Worker Capacity</a></h2>
<p>Training, mentoring, and supervision of primary health clinicians and village health workers<!--
<br>
...
<!-- begin box 3 -->
<div class="box_last">
<a href="#" onclick="gonav(5); return false;"><img src="img/home/content_boxes/4.jpg" alt="Mobilizing Communities" title="" border="0"></a>
<h2><a href="#" onclick="gonav(5); return false;">Mobilizing Communities</a></h2>
...
<div class="box_lg">
<!-- <h2>About Us</h2> -->
<p>Wild4life is a non-profit organization that expands the reach of health services in underserved communities in sub-Saharan Africa. We develop health worker capacity, build functioning clinics, and mobilize communities that, together, close the implementation gap between local communities and national health strategies. </p>
</div>
...
<p>Rural communities in sub-Saharan Africa are severely impacted by diseases like HIV, TB, malaria, pneumonia, and common illnesses such as diarrhea. By connecting and partnering with local networks, organizations and leadership, Wild4life harnesses the power of local resources to address barriers to health service delivery and bring critical primary health coverage to even the most remote populations. </p>
