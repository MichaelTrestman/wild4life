...
<h1>Background</h1>
<p>Wild4life started as an HIV program. However, years of working in the field showed that a silo-ed approach to health had little real impact on the health of rural communities. This, combined with a growing understanding of the health needs of rural communities in sub-Saharan Africa, led the program to evolve (through necessity), into a more comprehensive approach that now addresses all of the main health issues affecting rural communities. While service delivery remains our top priority, the program focuses on developing rural health systems that build local ownership and that will be sustainable in the longer-term.</p>
</div>
</div>
</div>
</div>
...
<p>Wild4life is a US registered 501(c)3 non-profit organization. The founder is a Zimbabwean, now based in the US. Wild4life operates offices in San Francisco and Harare in Zimbabwe. Currently, our main operations are in the critically underserved Hwange District in North-western Zimbabwe near Victoria Falls. Other programs are in Nigeria along the Nigeria/Cameroon border. In the past, Wild4life has operated programs in Kenya, Rwanda, South Africa, Botswana, Zambia, Tanzania, Ethiopia, Gabon, Cameroon, and Mozambique.</p>
</div>
...
var team_remove = [1,2,3,4,7,8,9,10,11,12,13,14,16,19];
...
is_advisory = <?php echo ($page_id == 2) ? 'true' : 'false'; ?>;
	if (is_team)
	dont_change = (bionum !== false && team_remove.indexOf(bionum) != -1);
	if (is_govern)
...
get_el('whobiocontent').innerHTML = biocontent[bionum]['bio'];
	...
	if (is_team) {
		for(i=0;i<biocontent.length;i++) {
			if (is_team)
			do_change = (team_remove.indexOf(i) == -1);
			if (is_govern)
			do_change = (i != 0);
			if (is_advisory)
			do_change = true;
...
biocontent[5]['bio'] = 'Zimbabwe Program Director';
biocontent[6] = new Array();
...
biocontent[23] = new Array();
biocontent[23]['name'] = 'Imelda Mahaka';
biocontent[23]['bio'] = 'Zimbabwe Country Co-ordinator';
biocontent[24] = new Array();
biocontent[24]['name'] = 'Latelang';
biocontent[24]['bio'] = 'Zimbabwe Clinical Manager';
biocontent[25] = new Array();
biocontent[25]['name'] = 'Louis Nkonyu';
biocontent[25]['bio'] = 'Nigeria Program Coordinator';
</script>
...
<div class="main_photo"><img src="img/who/team/20-lrg.jpg" alt="" title="" border="0" width="216" height="216" id="mainimg"></div>

<div class="box dark"><img src="img/common/x.gif" alt="" title="" border="0" id="img9"></div>
...
<div class="box light"><a href="#" onclick="change_who(24); return false;"><img src="img/who/team/24.jpg" alt="" title="" border="0" id="img24"></a></div>
...
<div class="box light"><img src="img/common/x.gif" alt="" title="" border="0" id="img13"></div>
<div class="box light"><a href="#" onclick="change_who(0); return false;"><img src="img/who/team/0.jpg" alt="" title="" border="0" id="img0"></a></div>

<div class="box light"><img src="img/common/x.gif" alt="" title="" border="0" id="img16"></div>
...
<div class="box light"><a href="#" onclick="change_who(23); return false;"><img src="img/who/team/23.jpg" alt="" title="" border="0" id="img23"></a></div>
<div class="box light"><img src="img/common/x.gif" alt="" title="" border="0" id="img8"></div>
...
<div class="box dark"><a href="#" onclick="change_who(25); return false;"><img src="img/who/team/25.jpg" alt="" title="" border="0" id="img25"></a></div>
<div class="box dark"><img src="img/common/x.gif" alt="" title="" border="0" id="img4"></div>

<div class="box dark"><a href="#" onclick="change_who(6); return false;"><img src="img/who/team/6.jpg" alt="" title="" border="0" id="img6"></a></div>
<div class="box light"><img src="img/common/x.gif" alt="" title="" border="0" id="img14"></div>
<div class="box light"><a href="#" onclick="change_who(5); return false;"><img src="img/who/team/5.jpg" alt="" title="" border="0" id="img5"></a></div>
<div class="box dark"><a href="#" onclick="change_who(20); return false;"><img src="img/common/x.gif" alt="" title="" border="0" id="img20"></a></div>
<div class="box dark"><img src="img/common/x.gif" alt="" title="" border="0" id="img10"></div>
...
<div class="box light"><img src="img/common/x.gif" alt="" title="" border="0" id="img12"></div>

<h3 id="whobioheader" style="margin: 8px 0 0 6px; clear: both;"><script type="text/javascript">document.write(biocontent[20]['name']);</script></h3>
<div id="whobiocontent">
<script type="text/javascript">document.write(biocontent[20]['bio']);</script>
</div>
<?php } ?>
...
<div class="main_photo"><img src="img/who/governing/5-lrg.jpg" alt="" title="" border="0" width="216" height="216" id="mainimg"></div>
...
<div class="box dark"><a href="#" onclick="change_who(1); return false;"><img src="img/who/governing/1.jpg" alt="" title="" border="0" id="img1"></a></div>
<div class="box light"><a href="#" onclick="change_who(5); return false;"><img src="img/common/x.gif" alt="" title="" border="0" id="img5"></a></div>
